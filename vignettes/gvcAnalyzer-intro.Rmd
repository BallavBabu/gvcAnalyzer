...
At the world level, the BM 2025 output-based decomposition satisfies
the balance condition `sum(GVC_PF_X) = sum(GVC_PB_X)`, mirroring the
equality between upstream and downstream participation in value-added
terms.
